...
export function SplineSceneBasic() {
  return (
    <Card className="w-full h-auto min-h-[700px] md:h-[600px] bg-black/[0.96] relative overflow-hidden">
      <Spotlight
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="flex-1 p-8 md:p-12 relative z-10 flex flex-col justify-center items-center md:items-start text-center md:text-left">
          <h1 className="text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
            Your Real Estate <br /> AI Agent
          </h1>
          <p className="mt-4 text-neutral-300 max-w-lg text-lg md:text-xl">
            Protects your time and save your commissions.
          </p>
        </div>

        {/* Right content */}
        <div className="flex-1 relative w-full h-[400px] md:h-full md:scale-90">
          <SplineScene 
